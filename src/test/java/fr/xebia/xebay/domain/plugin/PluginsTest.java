...
public class PluginsTest {
    ...
    public void should_activate_plugin() {
        ...
        plugins.activate("BankBuyEverything", new Items(new Item("category", "name", new Amount(4.3))));
    ...
    public void should_deactivate_plugin() {
        ...
        plugins.activate("AllItemsInCategory", new Items(new Item("category", "name", new Amount(4.3))));
